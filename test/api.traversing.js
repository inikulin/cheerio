...
describe('$(...)', function () {
    ...
    describe('.parents', function () {
        ...
        it('() : should return the parents of every element in the *reveresed* collection, omitting duplicates', function () {
            ...
            expect($parents[2].tagName).to.be('body');
            expect($parents[3].tagName).to.be('html');
    ...
    describe('.addBack', function () {
        describe('() : ', function () {
            ...
            it('includes parents and self', function () {
                ...
                expect($selection[0].tagName).to.be('html');
                expect($selection[1].tagName).to.be('body');
                expect($selection[2]).to.be($('#food')[0]);
                expect($selection[3]).to.be($('#fruits')[0]);
                expect($selection[4]).to.be($('.apple')[0]);
            });
        });
